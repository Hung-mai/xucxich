...
public class PlatformPush_Manager : Minigame_Manager {
    public static PlatformPush_Manager ins;

    public float speedDamagedChar = 30;

    [Header("--------------- ref ---------------")]
    public PlatformPush_Map platformPush_Map;
    ...
    public override void InitGame() {
        ...
        listChars[0].speedBack = speedDamagedChar * 1.05f;
        ...
        for (int i = 1; i < maxCharacter; i++) {
            ...
            listChars[i].AIBot.TargetBlockNext();
